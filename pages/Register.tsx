    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-6 bg-orange-50">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          <button 
            onClick={onBack}
            className="absolute top-6 left-6 w-10 h-10 rounded-full bg-white flex items-center justify-center text-orange-500 shadow-sm"
          >
            <span className="material-icons-round">arrow_back</span>
          </button>
          <div className="inline-block p-4 bg-orange-100 rounded-2xl mb-4">
            <div className="w-20 h-20 rounded-full bg-white flex items-center justify-center">
              <span className="material-icons-round text-orange-500 text-5xl">waving_hand</span>
            </div>
          </div>
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8">
          <h2 className="text-2xl font-bold text-center text-gray-800 mb-2">欢迎你，小朋友！</h2>
          <p className="text-center text-gray-500 mb-8">让我们一起来学习手语吧</p>
