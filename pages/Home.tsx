        ...
        <div className="px-6 mb-4 flex items-center justify-between">
          ...
          <div className="w-28 flex justify-center">
            <div className="animate-bounce-slow relative">
              <img alt="打招呼猩猩" className="w-24 h-24 drop-shadow-xl object-contain" src="/orangutan-wave.png" loading="lazy"/>
            </div>
          </div>
        </div>
      </div>
          ...
          >
            <div className="grid grid-cols-2 gap-4">
              <div 
                ...
                className="col-span-2 bg-red-100 rounded-3xl p-1 relative overflow-hidden group hover:scale-[1.01] transition-transform cursor-pointer active:scale-[0.99]"
              >
              ...
              <div 
                ...
                className="bg-orange-100 rounded-3xl p-1 relative overflow-hidden group hover:scale-[1.02] transition-transform cursor-pointer active:scale-[0.98]"
              >
              ...
              <div 
                ...
                className="bg-yellow-100 rounded-3xl p-1 relative overflow-hidden group hover:scale-[1.02] transition-transform cursor-pointer active:scale-[0.98]"
              >
              ...
              <div 
                ...
                className="col-span-2 bg-green-100 rounded-3xl p-1 relative overflow-hidden group hover:scale-[1.02] transition-transform cursor-pointer active:scale-[0.98]"
              >
